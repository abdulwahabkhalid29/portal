...
<div class="card p-2">
  ...
  </div>      <form action="{{ route('admin.job-seeker.update',$seeker->id) }}" method="POST" enctype="multipart/form-data"> 
          @csrf
          @method('PUT')
          <div class="row">
              <div class="col-4">
                <div class="input-field">
                  ...
                  <input type="text" class="form-control" value="{{ $seeker->title }}" name="title" required>
                </div>
              </div>
              ...
              <div class="col-4">
                <div class="input-field">
                  ...
                  <input type="text" class="form-control" value="{{ $seeker->qualification }}" name="qualification">
                </div>
              </div>
              ...
              <div class="col-4">
                <div class="input-field">
                  ...
                  <input type="text" name="industry" class="form-control" value="{{ $seeker->industry }}">
                </div>
              </div>
              ...
              <div class="col-4 mt-3">
                  <div class="input-field">
                      ...
                      <input type="number" class="form-control" value="{{ $seeker->expected_salary }}" name="expected_salary" id="firstNameinput">
                  </div>
              </div>
                ...
                <div class="col-4 mt-3">      
                  <div class="input-field">
                    ...
                    <input type="text" class="form-control" name="city" value="{{ $seeker->city }}" required>
                  </div>
                </div>
            <div class="col-4">
              <div class="input-field">
                  ...
                  <input type="text" name="skills" value="{{ $seeker->skills }}" class="form-control" >
              </div>
            </div>
            ...
            <div class="mb-3">
                ...
                <select name="member_id" class="select2 form-control p-3" required>
                  ...
                  @foreach ($users as $user)
                      <option {{ ($seeker->member_id) == $user->id ? 'selected' : '' }} value="{{ $user->id }}">{{ $user->name }}</option>
                  @endforeach
                </select>
            </div>    
          </div><!--end col-->
