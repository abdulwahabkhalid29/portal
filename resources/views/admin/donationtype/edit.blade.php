...
@section('content')
    <div class="card p-2">
        <div class="card-body p-4">
            <div class="row">
                <div class="col-md-6">
                  <h5 class="fw-bold mb-4">Edit Donation Type</h5>
                </div>
                <div class="col-md-6">
            ...
            </div>             <form action="{{ route('admin.donationtype.update',$donation_type->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" name="name" id="firstNameinput" value="{{ $donation_type->name }}" placeholder="" required>
                        </div>
                </div>
                </div>
                <div class="text-end">
