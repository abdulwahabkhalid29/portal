...
@section('content')
    <div class="card p-2">
        <div class="card-body p-4">
            <div class="row">
                <div class="col-md-6">
                  <h5 class="fw-bold mb-4">Add Donations</h5>
                </div>
                <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="input-field col s12">
                            <label for="firstNameinput" class="form-label">Ammount</label>
                            <input type="number" class="form-control" name="amount" id="firstNameinput">
                        </div>
                    </div>
                    <div class="col-6 mt-3">
                        <div class="mb-3">
                            ...
                            <select name="type_id" class="select2 form-control p-3" required>
                              <option selected disabled>--Select Donation--</option>
                              @foreach ($donation_types as $donation_type)
                                  <option value="{{ $donation_type->id }}">{{ $donation_type->name }}</option>
                              @endforeach
                            </select>
                        </div>    
                      </div>
