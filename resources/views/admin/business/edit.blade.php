        ...
        @method('PUT')
          ...
          <div class="row">
              ...
              <div class="col-6">
                    ...
                    <input name="name" type="text" class="validate" id="firstNameinput" value="{{$business->name}}" required>
              ...
              <div class="col-6">
                ...
                <div class="input-field col s12">
                  ...
                  <input type="email" name="email" class="validate" value="{{$business->email}}" id="lastNameinput" required>
                  <span class="help-block" ng-show="errorFname"></span> 
                  </div>
              </div>
              ...
              <div class="col-6">
                <div class="input-field col s12">
                  ...
                  <input type="number" name="phone_number" class="validate" value="{{$business->phone_number}}" id="lastNameinput">
                  <span class="help-block" ng-show="errorFname"></span> 
                  </div>
            ...
            <div class="col-6">
                ...
                <div class="input-field col s12">
                  ...
                  <input type="text" name="website" class="validate" value="{{$business->website}}" id="lastNameinput">
                  <span class="help-block" ng-show="errorFname"></span> 
                  </div>
          </div>
                ...
                <div class="input-field col s12">
                    ...
                    <select name="member_id" class="select2 form-control p-3" required>
                      ...
                      @foreach ($users as $user)
                          <option {{ ($business->member_id) == $user->id ? 'selected' : '' }} value="{{ $user->id }}">{{ $user->name }}</option>
                      @endforeach
                    </select>
          ...
          <div class="col-6 mb-4 mt-3">
              ...
              <div class="input-field col s12">
               ...
               <input type="file" class="form-control" name="logo" onChange="{{$business->logo}}" id="lastNameinput">
                    <img src="{{asset('upload/logo/'.$business->logo)}}" alt="" width="150px" class="img-thumbnail mt-3">
            </div>
          </div>
              ...
              <div class="col-12">
                ...
                <div class="input-field col s12">
                  ...
                  <input type="text" name="introduction" class="validate" value="{{$business->introduction}}" id="address1ControlTextarea">
                  <span class="help-block" ng-show="errorFname"></span> 
                  </div>
              ...
              <div class="col-12">
                ...
                <div class="input-field col s12">
                  ...
                  <input type="text" name="address" class="validate" value="{{$business->address}}" id="address1ControlTextarea">
                  <span class="help-block" ng-show="errorFname"></span> 
                  </div>
            </div>
              ...
              <div class="col-4">
                ...
                <div class="input-field col s12">
                  ...
                  <input type="text" name="fb_link" class="validate" value="{{$business->fb_link}}" id="citynameInput">
                  <span class="help-block" ng-show="errorFname"></span> 
                  </div>
              </div>
              ...
              <div class="col-4">
                ...
                <div class="input-field col s12">
                  ...
                  <input type="text" name="insta_link" class="validate" value="{{$business->insta_link}}" id="citynameInput">
                  <span class="help-block" ng-show="errorFname"></span> 
                  </div>
            </div>
            ...
            <div class="col-4">
                ...
                <div class="input-field col s12">
                  ...
                  <input type="text" name="linkedin_link" class="validate" value="{{$business->linkedin_link}}" id="citynameInput">
                  <span class="help-block" ng-show="errorFname"></span> 
                  </div>
          </div>
