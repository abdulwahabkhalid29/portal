    ...
    <div class="layout-width">
        ...
        <div class="navbar-header">
            ...
            <div class="d-flex">
                ...
                <button type="button"
                    class="btn-sm px-3 fs-16 header-item vertical-menu-btn topnav-hamburger shadow-none" style="background-color: #fff;  color: black;
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="ms-1 header-item d-none d-sm-flex">
                    ...
                    <button type="button"
                        class="border-white btn-icon btn-topbar btn-ghost-secondary rounded-circle shadow-none"
                        data-toggle="fullscreen" style="background-color: #fff;  color: black;
                    border: 2px solid #fff;">
                ...
                <div class="ms-1 header-item d-none d-sm-flex">
                    ...
                    <button type="button"
                        class="border-white btn-icon btn-topbar btn-ghost-secondary rounded-circle light-dark-mode shadow-none"
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    ...
                    <button type="button" class=" shadow-none" id="page-header-user-dropdown"
                        data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="background-color: #f3f3f9;  color: black;
