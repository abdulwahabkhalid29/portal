...
<head>
    ...
    <meta name="csrf-token" content="{{ csrf_token() }}?_={{ time() }}">
...
<body>
    ...
    <button onclick="topFunction()" class=" btn-icon text-light" style="background-color: #45cb85;  border:white 1px solid;" id="back-to-top">
